...
test('OSS docs match public tool surface and security model', () => {
  ...
  assert.ok(readme.includes('MCP Tools (11 focused tools)'), 'README should advertise the actual 11-tool surface');
  assert.ok(readme.includes('Experimental Codex Hook Setup'), 'README should mark Codex hooks as experimental/manual');
  assert.ok(architecture.includes('Tools actuales (11)'), 'Architecture should describe the current 11-tool surface');
